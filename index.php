...
<i class="fas fa-user fa-lg"></i><input  type="text" class="form-control" placeholder="Digite seu nome aqui." name="nomeLogin" required ><br>
<i class="fas fa-key fa-lg"></i><input  type="password" class="form-control" placeholder="Digite sua senha aqui." name="senhaLogin" required ><br>
